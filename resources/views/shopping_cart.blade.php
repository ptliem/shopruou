	...
	<div id="header">
		...
		<div class="header-body">
			<div class="container beta-relative">
				<div class="pull-left">
					<a href="index.html" id="logo"><img src="assets/dest/images/cf19e6887db88fe6d6a9.jpg" width="200px" alt=""></a>
				</div>
						...
						<div class="cart">
							...
							<div class="beta-dropdown cart-body">
								<div class="cart-item">
									...
									<div class="media">
										<a class="pull-left" href="#"><img src="assets/dest/images/products/cart/Macallan-15-years-old-700ml.jpg" alt=""></a>
										<div class="media-body">
											<span class="cart-item-title">Rượu Single Malt Macallan 15 years old 700ml/43%</span>
											<span class="cart-item-options">THỂ TÍCH: 700 ml; NỒNG ĐỘ: 43 độ</span>
											<span class="cart-item-amount">1*<span>2,700,000đ</span></span>
										</div>
									</div>
								</div>
								...
								<div class="cart-item">
									...
									<a class="cart-item-delete" href="#"><i class="fa fa-times"></i></a>
									<div class="media">
										<a class="pull-left" href="#"><img src="assets/dest/images/products/cart/Macallan-Classic-Cut-2017-RELEASE-700ml.jpg" alt=""></a>
										<div class="media-body">
											<span class="cart-item-title">Rượu Single Malt Rượu The Macallan Classic Cut – 2019 RELEASE </span>
											<span class="cart-item-options">THỂ TÍCH: 700 ml; NỒNG ĐỘ: 58.4 độ</span>
											<span class="cart-item-amount">1*<span>3,500,000đ</span></span>
										</div>
									</div>
								</div>
								...
								<div class="cart-item">
									...
									<a class="cart-item-delete" href="#"><i class="fa fa-times"></i></a>
									<div class="media">
										<a class="pull-left" href="#"><img src="assets/dest/images/products/cart/Macallan-18-Years-Old-Fine-Oak-750ml.jpg" alt=""></a>
										<div class="media-body">
											<span class="cart-item-title">Rượu Single Malt Macallan 18 Years Old Fine Oak </span>
											<span class="cart-item-options">THỂ TÍCH: 750 ml; NỒNG ĐỘ: 43 độ</span>
											<span class="cart-item-amount">1*<span>5,600,000đ</span></span>
										</div>
									</div>
								</div>
					...
					<tbody>
						...
						<tr class="cart_item">
							<td class="product-name">
								<div class="media">
									<img class="pull-left" src="assets/dest/images/Macallan-15-years-old-700ml.jpg" alt="">
									<div class="media-body">
										<p class="font-large table-title">Rượu Single Malt Macallan 15 years old 700ml/43%
THỂ TÍCH: 700 ml; NỒNG ĐỘ: 43 độ</p>
										<p class="table-option">NỒNG ĐỘ: 43 độ</p>
										<p class="table-option">THỂ TÍCH: 700 ml</p>
							...
							<td class="product-price">
								<span class="amount">2,700,000đ</span>
							</td>
						...
						<tr class="cart_item">
							<td class="product-name">
								<div class="media">
									<img class="pull-left" src="assets/dest/images/Macallan-Classic-Cut-2017-RELEASE-700ml.jpg" alt="">
									<div class="media-body">
										<p class="font-large table-title">Rượu Single Malt Rượu The Macallan Classic Cut – 2019 RELEASE 700ml/58.4%</p>
										<p class="table-option">NỒNG ĐỘ: 58.4 độ</p>
										<p class="table-option">THỂ TÍCH: 700 ml</p>
										<a class="table-edit" href="#">Edit</a>
									</div>
								</div>
						...
						<tr class="cart_item">
							<td class="product-name">
								<div class="media">
									<img class="pull-left" src="assets/dest/images/Macallan-18-Years-Old-Fine-Oak-750ml.jpg" alt="">
									<div class="media-body">
										<p class="font-large table-title">Rượu Single Malt Macallan 18 Years Old Fine Oak</p>
										<p class="table-option">NỒNG ĐỘ: 43 độ</p>
										<p class="table-option">THỂ TÍCH: 750 ml</p>
										<a class="table-edit" href="#">Edit</a>
									</div>
								</div>
							</td>
							...
							<td class="product-price">
								<span class="amount">5,600,000đ</span>
							</td>
