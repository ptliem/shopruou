...
<head>
	...
	<title>Shop Rượu &mdash; Liên hệ</title>
	...
	<div id="header">
		...
		<div class="header-body">
			<div class="container beta-relative">
				<div class="pull-left">
					<a href="http://127.0.0.1:8000" id="logo"><img src="assets/dest/images/Untitled-1.png" width="200px" alt=""></a>
				</div>
		...
		<div id="content" class="space-top-none">
			...
			<div class="row">
				...
				<div class="col-sm-4">
					...
					<p>
						Số 22 đường Đề Thám, phường 2<br>
						Thành phố Cà Mau <br>
						Việt Nam
					</p>
					<div class="space20">&nbsp;</div>
					...
					<p>
						...
						<a href="https://www.facebook.com/ptliema10/">Shop Rượu</a>
					</p>
					<div class="space20">&nbsp;</div>
					<h6 class="contact-title">Gmail liên hệ</h6>
					<p>

						<a href="ptliema10@gmail.com">ptliema10@gmail.com</a>
					</p>
				</div>
			</div>
		</div> <!-- #content -->
