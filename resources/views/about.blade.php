	...
	<div id="header">
		...
		<div class="header-body">
			<div class="container beta-relative">
				<div class="pull-left">
					<a href="http://127.0.0.1:8000/" id="logo"><img src="assets/dest/images/logo-cake.png" width="200px" alt=""></a>
				</div>
						...
						<div class="cart">
							...
							<div class="beta-dropdown cart-body">
								...
								<div class="cart-caption">
									...
									<div class="center">
										<div class="space10">&nbsp;</div>
										<a href="http://127.0.0.1:8000/checkout" class="beta-btn primary text-center">Đặt hàng <i class="fa fa-chevron-right"></i></a>
									</div>
								</div>
							</div>
						</div> <!-- .cart -->
				...
				<nav class="main-menu">
					<ul class="l-inline ov">
						...
						<li><a href="product">Sản phẩm</a>
							<ul class="sub-menu">
								<li><a href="http://127.0.0.1:8000/shopping_cart">Sản phẩm 1</a></li>
								<li><a href="http://127.0.0.1:8000/shopping_cart">Sản phẩm 2</a></li>
								<li><a href="http://127.0.0.1:8000/shopping_cart">Sản phẩm 3</a></li>
							</ul>
						</li>
	...
	<div class="container">
		<div id="content">
			<div class="our-history">
				<h2 class="text-center wow fadeInDown">Lịch Sử Thành Lập</h2>
